package org.apache.archiva.repository.impl;
...
import org.apache.archiva.repository.api.*;
...
public class RepositoryWeightComparitorTest
{
    @Test
    public void testRepositoryManagerWeights() throws Exception
    {
        DefaultRepositoryManager repositoryManager = new DefaultRepositoryManager(null);
        ...
        assertEquals(repositoryManager, managers.get(2));
    }
