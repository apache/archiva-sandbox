 ...
 * @version $Id$
 */
public interface TransferUploader
{
    /**
     * Add to the list of transfer monitors for the {@link TransferUploader}.
     * 
    ...
    /**
     * Remove from the list of transfer monitors on the {@link TransferUploader}.
     * 
    ...
    /**
     * Initiate an upload of a local sourceFile to a remote URI.
     * 
     * @param sourceFile the source file to upload.
     * @param uri the uri to upload to.
     * @throws TransferException if there was a problem initiating the upload.
