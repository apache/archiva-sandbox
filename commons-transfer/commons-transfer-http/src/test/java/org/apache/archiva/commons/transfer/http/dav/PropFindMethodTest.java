    ...
    extends AbstractDavTestCase
{
        ...
        throws Exception
    {
        ...
        // Execute Test
        URI testURI = davServer.baseURI.resolve( "links" );
        ...
        throws Exception
    {
        ...
        // Execute Test
        URI testURI = davServer.baseURI.resolve( "links/commons-lang.html" );
        PropFindMethod method = new PropFindMethod( testURI );
        HttpClient client = new HttpClient();
        int status = client.executeMethod( method );
        ...
        throws Exception
    {
        ...
        // Execute Test
        URI testURI = davServer.baseURI.resolve( "invalid/resource.txt" );
        PropFindMethod method = new PropFindMethod( testURI );
        HttpClient client = new HttpClient();
        int status = client.executeMethod( method );
