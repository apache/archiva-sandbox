package org.apache.archiva.jarinfo.bundler;
...
import org.apache.archiva.jarinfo.model.io.JarDetailsWriter;
import org.apache.archiva.repository.content.ArtifactException;
import org.apache.archiva.repository.content.ArtifactRef;
import org.apache.archiva.repository.content.DefaultPathParser;
    ...
    extends DirectoryWalker
{
        ...
        throws JarInfoBundlerException, IOException
    {
        ...
        boolean performInspection = true;
